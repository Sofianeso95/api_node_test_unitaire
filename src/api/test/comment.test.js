...
describe("commentController", () => {
  describe("getAllcomments", () => {
    it("should return all comments", async () => {
      ...
      const comments = [        { _id: "comment1", names: "so", content: "Comment 1" },        { _id: "comment2", names: "Sab", content: "Comment 2" },      ];
  ...
  describe("getcomments", () => {
    it("should return comments for a specific post", async () => {
      ...
      const comments = [        { _id: "comment1", names: "So", content: "Comment 1" },        { _id: "comment2", names: "Julie", content: "Comment 2" },      ];
